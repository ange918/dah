...
function validateWhatsAppIntent(message) {
    ...
    return confirm('Vous allez être redirigé vers WhatsApp pour contacter La voyante Francine. Continuer ?');
}
...
console.log('%c✨ Bienvenue sur le site de La voyante Francine ✨', 'font-size: 20px; font-weight: bold; color: #D4AF37;');
